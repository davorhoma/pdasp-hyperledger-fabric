...
createChannelGenesisBlock() {
  setGlobals 1
	...
	# Dinamički odabir profila na osnovu imena kanala
	local CHANNEL_PROFILE
	if [ "$CHANNEL_NAME" == "channel1" ]; then
	    CHANNEL_PROFILE="Channel1Profile"
	elif [ "$CHANNEL_NAME" == "channel2" ]; then
	    CHANNEL_PROFILE="Channel2Profile"
	else
	    # Default fallback - koristi Channel1Profile
	    CHANNEL_PROFILE="Channel1Profile"
	    warnln "Unknown channel name: $CHANNEL_NAME, using Channel1Profile as default"
	fi
