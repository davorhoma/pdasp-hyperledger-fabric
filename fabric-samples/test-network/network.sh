...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    ${CONTAINER_CLI} volume rm $(${CONTAINER_CLI} volume ls -q | grep 'orderer.example.com\|peer0.org1.example.com\|peer1.org1.example.com\|peer2.org1.example.com\|peer0.org2.example.com\|peer1.org2.example.com\|peer2.org2.example.com\|peer0.org3.example.com\|peer1.org3.example.com\|peer2.org3.example.com') 2>/dev/null || true
  ...
  ${CONTAINER_CLI} volume rm compose_orderer.example.com compose_peer1.org1.example.com compose_peer2.org2.example.com compose_peer0.org1.example.com  compose_peer1.org2.example.com  compose_peer2.org3.example.com compose_peer0.org2.example.com compose_peer1.org3.example.com compose_peer0.org3.example.com compose_peer2.org1.example.com
